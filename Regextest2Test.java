...
public class Regextest2Test {
    ...
    private static String REGEX = "(?<Letter>[À-ßà-ÿ]{1})\\W*(?<Figures>\\d{3})\\W*(?<Letters>[À-Áà-á]{2})\\D*(?<Region>\\d{2})";
    private static String number1 = "à000àá37";
    private static String number2 = "à 000 àà 37";
    private static String number3 = "à000àà ğåãèîí 37";
    private static String number4 = "à-000-àà-37";
    private static String number5 = "à-000-àà 37";
    ...
    public void testMain() {
        ...
        if (myMatch.find()) {
            ...
            assertEquals("à", myMatch.group(1));
            assertEquals("000", myMatch.group(2));
            assertEquals("àá", myMatch.group(3));
    ...
    public void testMain1() {
        ...
        if (myMatch.find()) {
            ...
            assertEquals("à", myMatch.group(1));
            assertEquals("000", myMatch.group(2));
            assertEquals("àà", myMatch.group(3));
            assertEquals("37", myMatch.group(4));
        } else {
            fail();
        }
